...
const EXCEL_FILE_PATH = EXCEL_FROM_ENV || 'C:\\Users\\juan.raymundo\\LAUAK SARL\\Lean Manufacturing - 02. FY2025\\03. Lauak Efficiency Report_July_2025.xlsx';
...
function buildInsertSQL(rowsCount) {
  // 24 columnas de datos + 1 columna calculada (uniq_hash)
  const baseCols = [
...
// Construye el array de parámetros por fila (24 datos + 8 para el hash)
